    ...
    <div class="jl-inline">
        <?php foreach ($list as $language) : ?>
            <?php if ($language->active) : ?>
                <button id="language_btn_<?php echo $module->id; ?>" type="button" class="jl-button jl-button-default dropdown-toggle" aria-haspopup="listbox" aria-labelledby="language_picker_des_<?php echo $module->id; ?> language_btn_<?php echo $module->id; ?>" aria-expanded="false">
        ...
        <ul aria-labelledby="language_picker_des_<?php echo $module->id; ?>" class="lang-block jl-nav jl-dropdown-nav">
        <?php foreach ($list as $language) : ?>
            <?php
                $lbl = '';
