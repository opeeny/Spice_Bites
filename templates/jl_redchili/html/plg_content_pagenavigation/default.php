...
<nav class="pagenavigation" aria-label="<?php echo Text::_('PLG_PAGENAVIGATION_ARIA_LABEL'); ?>">
    ...
    <li>
        ...
        <span jl-pagination-previous></span><?php echo ' <span aria-hidden="true">' . htmlspecialchars($row->prev_label) . '</span>'; ?>
        </a>
    </li>
    <?php endif; ?>
    <?php if ($row->next) :
        ...
        <li class="jl-margin-auto-left">
            ...
            <?php echo '<span aria-hidden="true">' . htmlspecialchars($row->next_label) . '</span> <span jl-pagination-next></span>'; ?>
            </a>
        </li>
    <?php endif; ?>
    </ul>
