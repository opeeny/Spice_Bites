...
return [
    ...
    'files' => [
        ...
        'templates/jl_redchili/config/default' => [
            'page/assets' => [
                'file' => 'templates/jl_redchili/config/default/page/assets.yaml',
                'modified' => 1775728761
            ],
            'page/body' => [
                'file' => 'templates/jl_redchili/config/default/page/body.yaml',
                'modified' => 1775728761
            ],
            'page/fontawesome' => [
                'file' => 'templates/jl_redchili/config/default/page/fontawesome.yaml',
                'modified' => 1775728761
            ],
            'page/head' => [
                'file' => 'templates/jl_redchili/config/default/page/head.yaml',
                'modified' => 1775728761
            ],
            'particles/branding' => [
                'file' => 'templates/jl_redchili/config/default/particles/branding.yaml',
                'modified' => 1775728761
            ],
            'particles/copyright' => [
                'file' => 'templates/jl_redchili/config/default/particles/copyright.yaml',
                'modified' => 1775728761
            ],
            'particles/logo' => [
                'file' => 'templates/jl_redchili/config/default/particles/logo.yaml',
                'modified' => 1775728761
            ],
            'particles/social' => [
                'file' => 'templates/jl_redchili/config/default/particles/social.yaml',
                'modified' => 1775728761
            ],
            'particles/totop' => [
                'file' => 'templates/jl_redchili/config/default/particles/totop.yaml',
                'modified' => 1775728761
            ],
            'styles' => [
                'file' => 'templates/jl_redchili/config/default/styles.yaml',
                'modified' => 1775728761
            ]
        ]
    ],
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                'messages' => [
                    'system-messages-8183' => 'System Messages'
                ],
                'content' => [
                    'system-content-1366' => 'Page Content'
                ],
                'position' => [
                    'position-position-1685' => 'Top A'
                ],
                'jlnavbar' => [
                    'jlnavbar-9662' => 'JL Navbar'
                ],
                'social' => [
                    'social-5459' => 'Social'
                ],
                'copyright' => [
                    'copyright-1888' => 'Copyright'
                ]
            ],
            'inherit' => [
                'default' => [
                    ...
                    'copyright' => 'copyright',
                    'offcanvas' => 'offcanvas',
                    'position-position-1685' => 'position-position-5937',
                    'jlnavbar-9662' => 'jlnavbar-2718',
                    'social-5459' => 'social-2254',
                    'copyright-1888' => 'copyright-6042'
                ]
            ]
        ],
        'layout' => [
                ...
                '/container-main/' => [
                    0 => [
                        ...
                        1 => [
                            'mainbar 50' => [
                                0 => [
                                    0 => 'system-messages-8183'
                                ],
                                1 => [
                                    0 => 'system-content-1366'
                                ]
                            ]
                        ],
                        2 => [
            ...
            'content' => [
                ...
                'jlnavbar-2718' => [
                    ...
                    'attributes' => [
                        'text' => 'SPICE BITES',
                        'image' => 'gantry-media://restaurant.jpg',
                        'menu' => 'redchili-theme',
                        'hoverExpand' => '1',
                        'menu_visibility' => 'm',
                        ...
                        'navbar_style' => 'extended',
                        'logo_color' => '#ffffff',
                        'navbar_dropdown_animation' => 'jl-animation-slide-left-small',
                        'subnav_extended' => 'drop',
                        'container_maxwidth' => 'default',
                        'main_nav_margin' => '1'
                    ],
                    'block' => [
