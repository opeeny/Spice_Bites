...
return [
    ...
    'filename' => 'D:\\Apache24\\htdocs\\Spice_Bites/templates/jl_bruno_free/particles/jloverlay.yaml',
    'modified' => 1775727462,
    'data' => [
        'name' => 'JL Overlay',
        ...
        'form' => [
            ...
            'fields' => [
                        ...
                        '_tab_overlay' => [
                            ...
                            'fields' => [
                                ...
                                'overlay_hover' => [
                                    ...
                                    'description' => 'Display overlay on hover',
                                    'default' => true
                                ],
                                'animate_background' => [
                                    'type' => 'input.checkbox',
                                    'label' => 'Animate background',
                                    'description' => 'Animate background only',
                                    'default' => false
                                ],
                                'overlay_style' => [
                                    'type' => 'select.select',
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Overlay <strong>Version: 2.3.4</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/overlay-particle-documentation/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
