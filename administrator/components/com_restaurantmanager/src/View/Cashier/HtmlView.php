...
namespace Joomla\Component\RestaurantManager\Administrator\View\Cashier;
...
/**
 * View class for cashier dashboard
 */
class HtmlView extends BaseHtmlView
{
    ...
    {
        ToolbarHelper::title(Text::_('COM_RESTAURANTMANAGER_CASHIER_DASHBOARD'), 'icon-food');
