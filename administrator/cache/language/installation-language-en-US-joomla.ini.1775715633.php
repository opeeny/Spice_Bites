...
return array (
  ...
  'BUILD_INCOMPLETE_URL_TEXT' => '[ More Detail %s ]',
  ...
  'INSTL_NOTICE_XML_SUPPORT' => 'XML Support is not available. This should be enabled by default in php but Ubuntu users, may need to install by doing <code>sudo apt-get install php-xml</code> followed by web server restart.',
  ...
  'INSTL_DATABASE_ENCRYPTION_MSG_CONN_NOT_ENCRYPT' => 'You have selected database connection encryption to be used, and a connection could be established, but it was not encrypted. The reason might be that the database server is configured to fall back to an unencrypted connection in case of bad encryption parameters. Either check and correct the database encryption parameters, or change field "Connection Encryption" back to "Default (server controlled)".',
  ...
  'JGLOBAL_SELECT_NO_RESULTS_MATCH' => 'Select some options',
  ...
  'JLIB_DATABASE_ERROR_VALID_MAIL' => 'Automate.',
  ...
  'NOTICE' => 'Notice',
  'WARNING' => 'Warning',
  'JLIB_JS_AJAX_ERROR_CONNECTION_ABORT' => 'A connection abort has occured while fetching the JSON data.',
